...
<div class='col-md-18'>
    ...
    if($communities[0]!='') {
        ...
        //echo $rqCommunities;
        $article = DB::SqlToObj(array('product', 'article'), "SELECT DISTINCT prod_id,arti_pictures,arti_price,prod_name ,count('requ_id') as nb FROM request,product,article,share_community WHERE requ_prod_id = prod_id AND prod_id = arti_prod_id AND arti_pictures != '[]' " . $rqCommunities . " AND shac_prod_id = arti_prod_id GROUP BY requ_prod_id
ORDER BY nb DESC");
