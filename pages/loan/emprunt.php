<div class="row2">
   <div class="col-md-18 title">
    ...
    <div class="col-md-18 lend" style="min-height: 500px;">
        <?php if($req_emprunt != array()){ ?>
        <?php foreach ($req_emprunt as $offset => $r) : ?>
                <?php //var_dump($r); ?>
            <div class="col-md-16 col-md-offset-1 req_pret">
                ...
                <div class="col-md-4" style="padding: 0;">
                    ...
                    <div class="col-md-18" style="padding: 0;">
                        ...
                        <?php switch ($r[0]->getStatus()['code']) :
                            case \request_status::STATUS_ASK : ?>
                                <form action="<?php echo WEBDIR ?>loan/emprunt/cancel" method="post">
                                    <input type="hidden" id="requ_id" name="requ_id" value="<?php echo $r[0]->getAttr('id') ?>">
                                    <div class="col-md-18" style="padding: 0;">
                                        <input type="submit" value="annuler" name="btn_annuler" id="btn_annuler"/>
                                    </div>
                                </form>
                                <?php break;
                            case \request_status::STATUS_REFUSED :
                            case \request_status::STATUS_CANCEL_BORROWER: ?>
                                <form action="<?php echo WEBDIR ?>loan/emprunt/delete" method="post">
                                    <input type="hidden" id="requ_id" name="requ_id" value="<?php echo $r[0]->getAttr('id') ?>">
                                    <input type="submit" value="supprimer" name="btn_delete_emprunt" id="btn_delete"/>
                                </form>
                                <?php break;
                            ...
                            case \request_status::STATUS_ENDED : ?>
                                <?php if($r[0]->getAttr('borrower_nota_id') == null){ ?>
                                        ...
                                        <input type="button" value="noter" name="btn_grade_pret" class="buttonAction" data-target="grade_pret_<?php echo $offset ?>"/>
                                <?php }elseif($r[0]->getAttr('borrower_archive') == 0 && $r[0]->getAttr('lender_nota_id') != null){ ?>
                                    <form action="<?php echo WEBDIR ?>loan/emprunt/archive" method="post">
                                        <input type="hidden" id="requ_id" name="requ_id" value="<?php echo $r[0]->getAttr('id') ?>">
                                ...
                                <?php break;
                            default : ?>
                                status = <?php echo $r[1]->getAttr('borrower_info') ?>
                            <?php case \request_status::STATUS_VALID :
                                if ($r[0]->getAttr('dateTo') < date('Y-m-d')) : ?>
                                    <!--<input type="button" value="noter" name="btn_grade_emprunt" class="buttonAction" data-target="grade_emprunt_<?php echo $offset ?>"/>-->
                                <?php else : ?>
                    ...
                    <div class="moderation" id="signal_<?php echo $offset ?>">
                        <div class="signal">
                            <form action="<?php echo WEBDIR ?>loan/emprunt/signal" method="post">
                                <input type="hidden" id="requ_id" name="requ_id" value="<?php echo $r[0]->getAttr('id') ?>">
                ...
                <div class="col-md-18" style="padding: 0;">
                    <div style="display: none;" id="grade_pret_<?php echo $offset ?>">
                        <form action="<?php echo WEBDIR ?>loan/emprunt/grade" method="post">
                            <input type="hidden" id="requ_id" name="requ_id" value="<?php echo $r[0]->getAttr('id') ?>">
                            <div class="col-md-18">
                                <div class="col-md-5 demande_item" style="padding: 0;">
                                    <label for="rank">note du prêteur :</label>
                                </div>
                                <div class="col-md-13">
                                    <span class="star-rating" style="margin-left: 35%;">
                                        <input type="radio" name="note_preteur" value="1"><i></i>
                                        <input type="radio" name="note_preteur" value="2"><i></i>
                                        <input type="radio" name="note_preteur" value="3"><i></i>
                                        <input type="radio" name="note_preteur" value="4"><i></i>
                                        <input type="radio" name="note_preteur" value="5"><i></i>
                                    </span>
                                </div>
                            </div>
                            <div class="col-md-18">
                                <div class="col-md-5 demande_item" style="padding: 0;">
                                    <label for="rank">note de l'objet :</label>
                                </div>
                                <div class="col-md-13">
                                    <span class="star-rating" style="margin-left: 35%;">
                                        <input type="radio" name="note_obj" value="1"><i></i>
                                        <input type="radio" name="note_obj" value="2"><i></i>
                                        <input type="radio" name="note_obj" value="3"><i></i>
                                        <input type="radio" name="note_obj" value="4"><i></i>
                                        <input type="radio" name="note_obj" value="5"><i></i>
                                    </span>
                                </div>
                            </div>
                            <div class="col-md-18 demande_item">
                                <label for="title">titre :</label>
                                <input type="text" id="title" name="title" value="Emprunt <?php echo $r[2]->getAttr('name') ?>"/>
                            </div>
                            <div class="col-md-18 demande_item">
        ...
        <?php endforeach ?>
        <?php }else{ ?>
            <p class="noemprunt">vous n'empruntez actuellement aucun objet.</p>
        <?php } ?>
    </div>
</div>
...
<script type="text/javascript">
    $(function() {
        $('.cancel_borrow').click(function(e){
            e.preventDefault();
